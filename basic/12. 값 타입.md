...
// 값 타입 컬렉션 제거 -> remove 는 기본적으로 equals 를 사용하기 때문에 값 타입에서 equals 가 중요해진다.
...
// 위 부분을 아래 처럼 변경한다. 경우에 따라서는 양방향 관계로 풀 수도 있다.
